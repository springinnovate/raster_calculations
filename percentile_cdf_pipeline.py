...
def main():
    ...
    table_path = r"C:\Users\Becky\Documents\cnc_project\landscan_percentiles_table_upper90.csv"
    # this is the directory the loop will search through
    base_directory = r"C:\Users\Becky\Documents\IPBES off dropbox\Landscan"
    # you can modify this list and the rest of the code will adapt
    # make a list full of 0s as long as the percentile list
    percentiles_list = [75, 95, 99, 99.5, 99.9, 99.99, 99.999, 100]  #list(range(0, 101, 1))
