...
#    return
    ...
    #python reclassify_by_table_copied_from_costaricasdr.py D:\ecoshard\CI_FP\Argentina\scenarios\ESA_mod_SSP1_Argentina_md5_6f3ded.tif "D:\ecoshard\SpawnESAmod2_Carbon_Lookup_Table_md5_e4a81a.csv" lucode 2010Mean
    #python reclassify_by_table_copied_from_costaricasdr.py D:\ecoshard\CI_FP\Argentina\scenarios\ESA_mod_SSP3_Argentina_md5_29633f.tif "D:\ecoshard\SpawnESAmod2_Carbon_Lookup_Table_md5_e4a81a.csv" lucode 2010Mean
    ...
    calculation_list = [ 
        {
            'expression': 'raster1 - raster2',
            'symbol_to_path_map': {
                'raster1': r"D:\ecoshard\CI_FP\Argentina\carbon\reclassified_ESA_mod_SSP1_Argentina_md5_6f3ded_SpawnESAmod2_Carbon_Lookup_Table_md5_e4a81a.tif",
                'raster2': r"D:\ecoshard\CI_FP\Argentina\carbon\reclassified_ESA_mod_2020_Argentina_md5_6640f4_SpawnESAmod2_Carbon_Lookup_Table_md5_e4a81a.tif",
            },
            'target_nodata': -9999,
            'target_pixel_size': (0.002777777777777777884,-0.002777777777777777884),
            'resample_method': 'near',
        ...
        },
        {
            'expression': 'raster1 - raster2',
            'symbol_to_path_map': {
                'raster1': r"D:\ecoshard\CI_FP\Argentina\carbon\reclassified_ESA_mod_SSP3_Argentina_md5_29633f_SpawnESAmod2_Carbon_Lookup_Table_md5_e4a81a.tif",
                'raster2': r"D:\ecoshard\CI_FP\Argentina\carbon\reclassified_ESA_mod_2020_Argentina_md5_6640f4_SpawnESAmod2_Carbon_Lookup_Table_md5_e4a81a.tif",
            },
            'target_nodata': -9999,
            'target_pixel_size': (0.002777777777777777884,-0.002777777777777777884),
        ...
        },
        {
            'expression': 'raster1 - raster2',
            'symbol_to_path_map': {
                'raster1': r"D:\ecoshard\CI_FP\Indonesia\carbon\reclassified_futurepluscurrent_viscose_ESA2020_modVCFv2_Indonesia_md5_64c967_SpawnESAmod2_Carbon_Lookup_Table_md5_e4a81a.tif",
                'raster2': r"D:\ecoshard\CI_FP\Indonesia\carbon\reclassified_current_viscose_ESA2020_modVCFv2_Indonesia_md5_b411a2_SpawnESAmod2_Carbon_Lookup_Table_md5_e4a81a.tif",
            },
            'target_nodata': -9999,
            'target_pixel_size': (0.002777777777777777884,-0.002777777777777777884),
            'resample_method': 'near',
    ...
    calculation_list = [
        {
            ...
            'target_pixel_size': (0.002777777777777777884,-0.002777777777777777884),
            'resample_method': 'near',
            'target_raster_path': r"D:\ecoshard\total_carbon_change_PNV-2010_spawn_Argentina_livestock.tif",
        },
        {
            'expression': 'raster1*raster2',
            'symbol_to_path_map': {
            ...
            'target_pixel_size': (0.002777777777777777884,-0.002777777777777777884),
            'resample_method': 'near',
            'target_raster_path': r"D:\ecoshard\total_carbon_change_PNV-2010_spawn_Indonesia_viscose.tif",
        },
        {
            'expression': 'raster1*raster2',
            'symbol_to_path_map': {
            ...
            'target_pixel_size': (0.002777777777777777884,-0.002777777777777777884),
            'resample_method': 'near',
            'target_raster_path': r"D:\ecoshard\total_carbon_change_PNV-2010_spawn_US_Cotton.tif",
        },
        {
            'expression': 'raster1*raster2',
            'symbol_to_path_map': {
            ...
            'target_pixel_size': (0.002777777777777777884,-0.002777777777777777884),
            'resample_method': 'near',
            'target_raster_path': r"D:\ecoshard\total_carbon_2010_spawn_Argentina_livestock.tif",
        },
        {
            'expression': 'raster1*raster2',
            'symbol_to_path_map': {
            ...
            'target_pixel_size': (0.002777777777777777884,-0.002777777777777777884),
            'resample_method': 'near',
            'target_raster_path': r"D:\ecoshard\total_carbon_2010_spawn_Indonesia_viscose.tif",
        },
        {
            'expression': 'raster1*raster2',
            'symbol_to_path_map': {
            ...
            'target_pixel_size': (0.002777777777777777884,-0.002777777777777777884),
            'resample_method': 'near',
            'target_raster_path': r"D:\ecoshard\total_carbon_2010_spawn_US_Cotton.tif",
        },
    ]
