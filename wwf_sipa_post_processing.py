...
duplicate: D:\repositories\wwf-sipa\final_results\service_sediment_IDN_restoration.tif
duplicate: D:\repositories\wwf-sipa\final_results\service_recharge_PH_restoration.tif
duplicate: D:\repositories\wwf-sipa\final_results\service_flood_mitigation_PH_restoration.tif
duplicate: D:\repositories\wwf-sipa\final_results\service_sediment_PH_restoration.tif
duplicate: D:\repositories\wwf-sipa\final_results\service_recharge_IDN_conservation_inf.tif
duplicate: D:\repositories\wwf-sipa\final_results\service_flood_mitigation_IDN_conservation_inf.tif
duplicate: D:\repositories\wwf-sipa\final_results\service_sediment_IDN_conservation_inf.tif
duplicate: D:\repositories\wwf-sipa\final_results\service_recharge_PH_conservation_inf.tif
duplicate: D:\repositories\wwf-sipa\final_results\service_flood_mitigation_PH_conservation_inf.tif
duplicate: D:\repositories\wwf-sipa\final_results\service_sediment_PH_conservation_inf.tif
...
SERVICE_FLOOD_MITIGATION_IDN_CONSERVATION_INF = os.path.join(RESULTS_DIR, "service_flood_mitigation_IDN_conservation_inf.tif")
SERVICE_FLOOD_MITIGATION_IDN_RESTORATION = os.path.join(RESULTS_DIR, "service_flood_mitigation_IDN_restoration.tif")
SERVICE_FLOOD_MITIGATION_PH_CONSERVATION_INF = os.path.join(RESULTS_DIR, "service_flood_mitigation_PH_conservation_inf.tif")
SERVICE_FLOOD_MITIGATION_PH_RESTORATION = os.path.join(RESULTS_DIR, "service_flood_mitigation_PH_restoration.tif")
SERVICE_RECHARGE_IDN_CONSERVATION_INF = os.path.join(RESULTS_DIR, "service_recharge_IDN_conservation_inf.tif")
SERVICE_RECHARGE_IDN_RESTORATION = os.path.join(RESULTS_DIR, "service_recharge_IDN_restoration.tif")
SERVICE_RECHARGE_PH_CONSERVATION_INF = os.path.join(RESULTS_DIR, "service_recharge_PH_conservation_inf.tif")
SERVICE_RECHARGE_PH_RESTORATION = os.path.join(RESULTS_DIR, "service_recharge_PH_restoration.tif")
SERVICE_SEDIMENT_IDN_CONSERVATION_INF = os.path.join(RESULTS_DIR, "service_sediment_IDN_conservation_inf.tif")
SERVICE_SEDIMENT_IDN_RESTORATION = os.path.join(RESULTS_DIR, "service_sediment_IDN_restoration.tif")
SERVICE_SEDIMENT_PH_CONSERVATION_INF = os.path.join(RESULTS_DIR, "service_sediment_PH_conservation_inf.tif")
SERVICE_SEDIMENT_PH_RESTORATION = os.path.join(RESULTS_DIR, "service_sediment_PH_restoration.tif")
...
SUBTRACT_RASTER_SET = [
    ...
    (r"D:\repositories\ndr_sdr_global\wwf_PH_baseline_ssp245_climate\stitched_sed_export_wwf_PH_baseline_ssp245_climate.tif",
     r"D:\repositories\ndr_sdr_global\wwf_PH_restoration_historical_climate\stitched_sed_export_wwf_PH_restoration_ssp245_climate.tif",
    ...
    (r"D:\repositories\ndr_sdr_global\wwf_PH_infra_historical_climate\stitched_sed_export_wwf_PH_infra_ssp245_climate.tif",
     r"D:\repositories\ndr_sdr_global\wwf_PH_baseline_ssp245_climate\stitched_sed_export_wwf_PH_baseline_ssp245_climate.tif",
...
MULTIPLY_RASTER_SET = [
    ...
    (DIFF_RECHARGE_IDN_RESTORATION,
     ...
     SERVICE_RECHARGE_IDN_RESTORATION),

    # DUP 2
    (DIFF_FLOOD_MITIGATION_IDN_RESTORATION,
     r"D:\repositories\wwf-sipa\downstream_beneficiary_workspace\num_of_downstream_beneficiaries_per_pixel_idn_downstream_dspop_benes_md5_e4d2c4.tif",
     SERVICE_FLOOD_MITIGATION_IDN_RESTORATION),
    (DIFF_SEDIMENT_IDN_RESTORATION,
     r"D:\repositories\wwf-sipa\downstream_beneficiary_workspace\num_of_downstream_beneficiaries_per_pixel_idn_downstream_dspop_benes_md5_e4d2c4.tif",
     SERVICE_SEDIMENT_IDN_RESTORATION),
    ...
    (DIFF_RECHARGE_PH_RESTORATION,
     ...
     SERVICE_RECHARGE_PH_RESTORATION),
    (DIFF_FLOOD_MITIGATION_PH_RESTORATION,
     r"D:\repositories\wwf-sipa\downstream_beneficiary_workspace\num_of_downstream_beneficiaries_per_pixel_ph_downstream_dspop_benes_md5_028732.tif",
     SERVICE_FLOOD_MITIGATION_PH_RESTORATION),
    (DIFF_SEDIMENT_PH_RESTORATION,
     r"D:\repositories\wwf-sipa\downstream_beneficiary_workspace\num_of_downstream_beneficiaries_per_pixel_ph_downstream_dspop_benes_md5_028732.tif",
     SERVICE_SEDIMENT_PH_RESTORATION),
    (DIFF_RECHARGE_PH_RESTORATION,
    ...
    (DIFF_RECHARGE_IDN_CONSERVATION_INF,
     r"D:\repositories\wwf-sipa\downstream_beneficiary_workspace\num_of_downstream_beneficiaries_per_pixel_idn_downstream_dspop_benes_md5_e4d2c4.tif",
     SERVICE_RECHARGE_IDN_CONSERVATION_INF),
    (DIFF_FLOOD_MITIGATION_IDN_CONSERVATION_INF,
     r"D:\repositories\wwf-sipa\downstream_beneficiary_workspace\num_of_downstream_beneficiaries_per_pixel_idn_downstream_dspop_benes_md5_e4d2c4.tif",
     SERVICE_FLOOD_MITIGATION_IDN_CONSERVATION_INF),
    (DIFF_SEDIMENT_IDN_CONSERVATION_INF,
     r"D:\repositories\wwf-sipa\downstream_beneficiary_workspace\num_of_downstream_beneficiaries_per_pixel_idn_downstream_dspop_benes_md5_e4d2c4.tif",
     SERVICE_SEDIMENT_IDN_CONSERVATION_INF),
    (DIFF_RECHARGE_IDN_CONSERVATION_INF,
     r"D:\repositories\wwf-sipa\downstream_beneficiary_workspace\num_of_downstream_beneficiaries_per_pixel_idn_downstream_road2019_benes_md5_8ec2cd.tif",
     SERVICE_RECHARGE_IDN_CONSERVATION_INF),
    (DIFF_FLOOD_MITIGATION_IDN_CONSERVATION_INF,
    ...
    (DIFF_RECHARGE_PH_CONSERVATION_INF,
     r"D:\repositories\wwf-sipa\downstream_beneficiary_workspace\num_of_downstream_beneficiaries_per_pixel_ph_downstream_dspop_benes_md5_028732.tif",
     SERVICE_RECHARGE_PH_CONSERVATION_INF),
    (DIFF_FLOOD_MITIGATION_PH_CONSERVATION_INF,
     r"D:\repositories\wwf-sipa\downstream_beneficiary_workspace\num_of_downstream_beneficiaries_per_pixel_ph_downstream_dspop_benes_md5_028732.tif",
     SERVICE_FLOOD_MITIGATION_PH_CONSERVATION_INF),
    (DIFF_SEDIMENT_PH_CONSERVATION_INF,
     r"D:\repositories\wwf-sipa\downstream_beneficiary_workspace\num_of_downstream_beneficiaries_per_pixel_ph_downstream_dspop_benes_md5_028732.tif",
     SERVICE_SEDIMENT_PH_CONSERVATION_INF),
    (DIFF_RECHARGE_PH_CONSERVATION_INF,
     r"D:\repositories\wwf-sipa\downstream_beneficiary_workspace\num_of_downstream_beneficiaries_per_pixel_ph_downstream_road2019_benes_md5_870a6c.tif",
     SERVICE_RECHARGE_PH_CONSERVATION_INF),
    (DIFF_FLOOD_MITIGATION_PH_CONSERVATION_INF,
